...
export const heroContent = {
  ...
  subtitle:
    "Джиу-джитсу – єдиноборство, стати спортсменом і переможцем в якому можна, почавши в будь-якому віці",
  supportingText:
    "Всі, хто має досвід, нагороди, звання чи просто хорошу фізичну форму колись наважились почати з нуля",
