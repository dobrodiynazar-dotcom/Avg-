import type { ContactPreview } from "@/types/content";
...
export function ContactSection({ preview }: ContactSectionProps) {
  return (
    <section className="section-frame">
      <Container className="grid gap-8 lg:items-start" size="wide">
        <SectionHeader size="feature" title="Де проходять тренування" />
